...
public class StatueEntityModel extends BipedEntityModel<StatueEntity> {
	...
	public StatueEntityModel(ModelPart root) {
		...
		this.left_arm_wide = root.getChild("left_arm");
		this.left_sleeve_wide = this.left_arm_wide.getChild("left_sleeve");
		this.right_arm_wide = root.getChild("right_arm");
		this.right_sleeve_wide = this.right_arm_wide.getChild("right_sleeve");
    ...
    protected ModelPart getArm(Arm arm) {
        if(arm.equals(Arm.RIGHT)){
            if(!right_arm_slim.hidden)
                return right_arm_slim;
            if(!right_arm_wide.hidden)
                return right_arm_wide;
        } else {
            if(!left_arm_slim.hidden)
                return left_arm_slim;
            if(!left_arm_wide.hidden)
                return left_arm_wide;
        }
        return right_arm_wide;
    }
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData body = root.addChild("body", ModelPartBuilder.create().uv(16, 16).cuboid(-4.0F, -6.0F, -2.0F, 8.0F, 12.0F, 4.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 6.0F, 0.0F));
        ...
        ModelPartData head = root.addChild("head", ModelPartBuilder.create().uv(0, 0).cuboid(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
        ...
        ModelPartData left_arm_slim = root.addChild("left_arm_slim", ModelPartBuilder.create().uv(32, 48).cuboid(0.0F, -1.0F, -2.0F, 3.0F, 12.0F, 4.0F, new Dilation(0.0F)), ModelTransform.pivot(4.0F, 1.0F, 0.0F));
		...
		ModelPartData right_arm_slim = root.addChild("right_arm_slim", ModelPartBuilder.create().uv(40, 16).cuboid(-3.0F, -1.0F, -2.0F, 3.0F, 12.0F, 4.0F, new Dilation(0.0F)), ModelTransform.pivot(-4.0F, 1.0F, 0.0F));
		...
		ModelPartData left_arm_wide = root.addChild("left_arm", ModelPartBuilder.create().uv(32, 48).cuboid(0.0F, -1.0F, -2.0F, 4.0F, 12.0F, 4.0F, new Dilation(0.0F)), ModelTransform.pivot(4.0F, 1.0F, 0.0F));

		ModelPartData left_sleeve_wide = left_arm_wide.addChild("left_sleeve", ModelPartBuilder.create().uv(48, 48).cuboid(-1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new Dilation(0.25F)), ModelTransform.pivot(1.0F, 1.0F, 0.0F));

		ModelPartData right_arm_wide = root.addChild("right_arm", ModelPartBuilder.create().uv(40, 16).cuboid(-4.0F, -1.0F, -2.0F, 4.0F, 12.0F, 4.0F, new Dilation(0.0F)), ModelTransform.pivot(-4.0F, 1.0F, 0.0F));

		ModelPartData right_sleeve_wide = right_arm_wide.addChild("right_sleeve", ModelPartBuilder.create().uv(40, 32).cuboid(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new Dilation(0.25F)), ModelTransform.pivot(-1.0F, 1.0F, 0.0F));

		ModelPartData left_leg = root.addChild("left_leg", ModelPartBuilder.create().uv(16, 48).cuboid(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new Dilation(0.0F)), ModelTransform.pivot(2.0F, 12.0F, 0.0F));
		...
		ModelPartData right_leg = root.addChild("right_leg", ModelPartBuilder.create().uv(0, 16).cuboid(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new Dilation(0.0F)), ModelTransform.pivot(-2.0F, 12.0F, 0.0F));
