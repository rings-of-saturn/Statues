...
public class ModPackets {
    public static void registerPackets(){
        ...
        PayloadTypeRegistry.playC2S().register(CopyStatueC2SPayload.ID, CopyStatueC2SPayload.CODEC);
        PayloadTypeRegistry.playC2S().register(PasteStatueC2SPayload.ID, PasteStatueC2SPayload.CODEC);
        PayloadTypeRegistry.playC2S().register(FlipStatueC2SPayload.ID, FlipStatueC2SPayload.CODEC);
    }
}
